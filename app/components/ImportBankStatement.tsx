...
export const ImportBankStatement = (props: any) => {
    ...
    const parsePdf = async (arr: any) => {
      ...
      const parser = new ParseBankStatementService();
    ...
    if (didUpload) {
      return <BankStatementReconciler import={parsed.current} accountId={account!._id} {...props}/>
    }
